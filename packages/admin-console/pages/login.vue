...
<script lang="ts">
import { API } from '../shio-rpc-client/v1'
import * as grpcWeb from 'grpc-web'
import { ShioAdminAPIClient } from '../shio-rpc-client/__generated__/endpoint/v1/shio_admin_api_grpc_web_pb'
import { LoginRequest, LoginResponse } from '../shio-rpc-client/__generated__/endpoint/v1/shio_admin_api_pb'
